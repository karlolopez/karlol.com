  ...
  function init_typed() {
    ...
    if ($typed.length) {
      var typed = new Typed("#typed", {
        strings: ["mobile developer", "digital creative", "🐱🐶 lover", "snapchat lens creator"],
        loop: true,
        typeSpeed: 70
      });
    }
  }
  function init_typed2() {
    var $typed = $("#typed2");
    if ($typed.length) {
      var typed = new Typed("#typed2", {
        strings: ["open source", "AR/VR", "snapchat", "coca-cola", "white-chocolate oreo", "apple (brand)", "visual studio code", "dark mode"],
        loop: true,
        typeSpeed: 70
      });
    }
